...
sns.set_style('ticks')
from kinetic_model.dead_Cas import get_energies
from kinetic_model.active_Cas import get_mismatch_positions, get_transition_states, get_transition_landscape
